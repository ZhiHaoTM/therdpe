...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=14899 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:83B640BA-96C1-E71E-60FA-BB71766D731D" "token:B331B10F-7184-1E3A-670D-5F3C11DA44B5" "policyid:35"
# /opt/ds_agent/dsa_control -a dsm://agents.workload.sg-1.cloudone.trendmicro.com:443/ "tenantID:83B640BA-96C1-E71E-60FA-BB71766D731D" "token:B331B10F-7184-1E3A-670D-5F3C11DA44B5" "policyid:35"
